        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (mdgroup1Entities db = new mdgroup1Entities())
            {
                ...
                using (mdgroup1Entities db2 = new mdgroup1Entities())
                {
                    ...
                    //var q = (from b in db.SiteTables
                    //         select b).LastOrDefault();
                    //var q = from s in db2.SiteTables
                    //        select s;
                    //int nnn = q.ToList().Last().SiteID;
                ...
                //int a = p.SiteID;
                //FormPlaceTime formPlaceTime = new FormPlaceTime(a);
